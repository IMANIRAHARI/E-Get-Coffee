...
<section class="home" id="home">
    ...
    <div class="row">
        ...
        <div class="content">
            ...
            <a href="buy.php" class="btn">buy one now</a>
        </div>
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content">
            ...
            <p>coffee that is delivered at the right time. The trendy food delivery
                partner. Good coffee is what we deliver. Your hunger companion.</p>
    ...
    <div class="swiper review-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                ...
                <p>We cover all the different types of coffee from lattes to red eyes. All of your burning coffee questions are *finally* answered.</p>
                <h3>jack boel</h3>
...
<section class="book" id="book">
    ...
    <form action="">
        ...
        <input type="number" placeholder="number of members" class="box">
